...
public class QuadMesh {
    ...
    public QuadMesh(float[] vertices, float[] textures, float[] normals, int[] indices, Shader shader) {
    ...
    private void initMesh() {
        ...
        gl.glBufferData(GL4.GL_ELEMENT_ARRAY_BUFFER, (long) indices.length * Integer.BYTES, IntBuffer.wrap(indices), GL4.GL_STATIC_DRAW);
    ...
    public void draw() {
        ...
        gl.glBindVertexArray(vaoId);
        gl.glDrawElements(GL4.GL_QUADS, vertexCount, GL4.GL_UNSIGNED_INT, 0);
        gl.glBindVertexArray(0);
    }
}
